                    ...
                    <div className={style.test_quality}>
                        <div className={`flex ${style.test_quality_title}`}>
                            <section>
                                ...
                                <p>DigiMark Developers offers comprehensive testing services for <span>desktop, web, & mobile applications.</span> With extensive experience across multiple platforms <span>(iOS, Android, Windows),</span> we employ functional and non-functional testing methods for analysis & performance evaluation.</p>
                            </section>
                        ...
                        <div className={`flex flex-wrap ${style.test_quality_content}`}>
                            <section>
                                ...
                                <p>Functional testing focuses on the system's functions and ensures its functional quality in terms of completeness, accuracy, and suitability. It is an essential or paramount component at all levels of testing. The testing techniques employed vary based on project specifications and the desired functional coverage. Commonly, black box testing techniques such as equivalence partitioning, boundary value analysis, decision tables, state transition testing, use cases, and pairwise testing are utilized for conducting functional testing.</p>
                            </section>
                            <section>
                                <h4>Non-Functional Testing</h4>
                                <p>Non-functional testing focuses on assessing the performance and user experience of a system by examining its behavior and impact.</p>
