...
export default function SaleTeamForms() {
    // State for the first checkbox
    const [isWebsiteChecked, setIsWebsiteChecked] = useState(true);
    const [isWebsiteChecked1, setIsWebsiteChecked1] = useState(true);
    const [isWebsiteChecked2, setIsWebsiteChecked2] = useState(true);
                    ...
                    <ul className="list-none flex flex-wrap">
                        ...
                        <li className="w-100">
                            ...
                            <div className={`flex flex-wrap ${style.checkbox_list}`}>
                                <div className="checkbox">
                                    <label htmlFor="1">
                                        {/* Manage the checked state of this checkbox */}
                                        <input
                                            id="1"
                                            type="checkbox"
                        ...
                        <li className="w-100">
                            ...
                            <div className={`flex flex-wrap ${style.checkbox_list}`}>
                                <div className="checkbox">
                                    <label htmlFor="6">
                                        <input id="6" type="checkbox" checked={isWebsiteChecked1}
                                            onChange={() => setIsWebsiteChecked1(!isWebsiteChecked1)} />
                                        <span>Up to $20K</span>
                                    </label>
                                </div>
                                <div className="checkbox">
                        ...
                        <li className="w-100">
                            ...
                            <div className={`flex flex-wrap ${style.checkbox_list}`}>
                                <div className="checkbox">
                                    <label htmlFor="11">
                                        <input id="11" type="checkbox" checked={isWebsiteChecked2}
                                            onChange={() => setIsWebsiteChecked2(!isWebsiteChecked2)} />
                                        <span>Finance</span>
                                    </label>
                                </div>
                                <div className="checkbox">
                        ...
                        <li>
                            <button className={`contact_btn ${style.contact_btn}`}>
                                Send Message <Image src={whiteArrow} alt={whiteArrow} width={13} height={16} />
                            </button>
                        </li>
                        <li className="w-100">
                            <p>
                                <span>or</span>
                                <Link href="https://calendly.com/digimark-developers" target="_blank">
