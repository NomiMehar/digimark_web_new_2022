...
import companyBanner from "../../../../public/assets/images/company/company_banner.jpg";
import careersImage from "../../../../public/assets/images/company/join.png";
        ...
        <div className={`flex direction-column ${props.careersImage === true ? `${companyStyle.careers_wrapper}` : ""} ${companyStyle[props.classProp]} ${companyStyle[props.extraClass]} ${companyStyle.company_banner}`}>
            <div className="container">
                <ul className={`list-none flex items-center ${companyStyle.breadcrumbs} ${style.breadcrumbs}`}>
                    <li><Image src={backArrow} alt={backArrow} width={32} height={29}/>{props.dynamicBread === true ? <span>{props.breadText}</span>:<span>Company</span> }</li>
